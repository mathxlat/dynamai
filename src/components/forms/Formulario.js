    ...
    return (
        <div className="formik--box">
            {formularioEnviado === false ? (
                <Formik
                    initialValues={{ institucion: "", contacto: "", email: "" }}
                    validate={validate}
                ...
                >
                    <Form className="main--form">
                        ...
                        <div className="separador--telefono">
                            <label name="telefono" className="label--telefono">
                        ...
                        <div className="optional--box">
                            ...
                            />
                            <button className="main--form_btn" type="submit">
                                ENVIAR
                            </button>
                        </div>
                    </Form>
                ...
                <div className="send--message-box">
                    <img
                        className="image-mother"
                        src="img/Png/mother.png"
                        alt="dibujo de mujer"
                    />
                    <h1 className="send--message-title">Mensaje enviado</h1>
                    <p className="message--text">
                        Tu mensaje fue enviado correctamente ¡Pronto recibiras
                        una respuesta!
                    </p>
                    <Link to="/">
                        <div className="btn--return-home">Volver al inicio</div>
                    </Link>
                </div>
            )}
        </div>
